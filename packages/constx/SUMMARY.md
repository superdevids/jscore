...
SpeexJS — Fullstack TypeScript framework. 🇮🇩 Indonesia first.
...
| `speexjs/server/middleware` | CORS, Auth, CSRF, Throttle, Session, Logger, dll |
...
| `speexjs/schema` | 25+ schema types, 🇮🇩 Indonesia validations |
